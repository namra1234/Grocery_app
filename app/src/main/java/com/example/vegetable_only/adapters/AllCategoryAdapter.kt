...
import com.example.vegetable_only.AllCategory
...
class AllCategoryAdapter(private  val context : Context, private val dataSet: ArrayList<Category>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            imageView = view.findViewById(R.id.allCategoryImage)
        }
    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.all_category_row_item, viewGroup, false)
